        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fullname = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Manager = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    lunchCorrectionForgot = table.Column<bool>(type: "bit", nullable: true),
                    lunchCorrection_start = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    lunchCorrection_end = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    reason = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    reason_Options = table.Column<string>(type: "nvarchar(max)", nullable: true),
