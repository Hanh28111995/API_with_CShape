        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ManagerStatus = table.Column<bool>(type: "bit", nullable: true),
                    HrDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Username = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Location = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TimeOffStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimeOffEnd = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    ManagerDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ManagerStatus = table.Column<bool>(type: "bit", nullable: true),
                    CoworkerDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Username = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateSubmit = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimeSheet_Start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimeSheet_End = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimeSheet_Break_Start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimeSheet_Break_End = table.Column<DateTime>(type: "datetime2", nullable: false),
